...
union TUSBDescriptor
{
	...
	struct TUSBConfigurationDescriptor	Configuration;
	struct TUSBInterfaceDescriptor		Interface;
	struct TUSBEndpointDescriptor		Endpoint;

	struct TUSBAudioEndpointDescriptor	AudioEndpoint;
	struct TUSBMIDIStreamingEndpointDescriptor MIDIStreamingEndpoint;
}
PACKED;
